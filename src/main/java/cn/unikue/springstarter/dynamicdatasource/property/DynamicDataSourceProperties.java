...
package cn.unikue.springstarter.dynamicdatasource.property;
...
import cn.unikue.springstarter.dynamicdatasource.config.DynamicDataSourceJdbcConfiguration;
...
public class DynamicDataSourceProperties implements Serializable {
    ...
    /**
     * The priority order of {@link cn.unikue.springstarter.dynamicdatasource.advisor.DataSourceDefinitionAdvisor}
     */
    private Integer definitionAdvisorOrder = Ordered.LOWEST_PRECEDENCE - 1000;

    /**
     * The priority order of {@link cn.unikue.springstarter.dynamicdatasource.advisor.DataSourceRoutingAdvisor}
     */
